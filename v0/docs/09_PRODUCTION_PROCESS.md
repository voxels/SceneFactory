...
Each shot formation becomes one storyboard task. A storyboard is a low-cost approval frame for composition, blocking, lens, action readability, and continuity. It is not the final production key frame.
